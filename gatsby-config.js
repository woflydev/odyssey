...
module.exports = {
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Project Odyssey's Official Website`,
        short_name: `Project Odyssey's Official Website`,
        start_url: `/`,
        background_color: `#1b2d3a`,
        theme_color: `#1b2d3a`,
        display: `minimal-ui`,
        icon: `src/images/odyssey.jpg`, // This path is relative to the root of the site.
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
